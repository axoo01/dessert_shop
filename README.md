...
## Live Demo
[View Live Project](ADD_YOUR_LIVE_LINK_HERE)

## Features
- **Dynamic Product List:** Fetches data from a local JSON source using Angular's `HttpClient`.
- **Reactive Shopping Cart:** Real-time updates using **Angular Signals** (Computed & Effect).
- **Responsive Design:** Mobile-first approach with CSS Grid and Flexbox, matching Figma designs for Mobile, Tablet, and Desktop.
- **Interactive UI:** Smooth transitions between "Add to Cart" and quantity selection states.
